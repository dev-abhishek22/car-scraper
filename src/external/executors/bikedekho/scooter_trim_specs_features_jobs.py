...
RESOURCE_NAME = "scooter-trim-specs-features"
JOB_TYPE = "fetch-scooter-trim-specs-features"

SOURCE_COLLECTION = "bikedekho_scooters"
TARGET_COLLECTION = "bikedekho_scooter_trim_specs_features"

COMMAND_NAME = "bikedekho-scooter-trim-specs-features"
...
def _validate_variant_record(
    ...
    return {
        "scooterDocumentId": value.get("scooterDocumentId"),
        "sourceScooterRunId": value.get("sourceScooterRunId"),
        ...
        "scooterSlug": value.get("scooterSlug") or model_slug,
...
async def iter_bikedekho_scooter_trim_specs_features_variants(
    *,
    ...
    async for document in cursor:
        ...
        for variant in variants:
            ...
            record = {
                "scooterDocumentId": document.get("_id"),
                ...
                "scooterSlug": document.get("scooterSlug"),
                "modelStatus": document.get("modelStatus"),
                "sourceScooterRunId": document.get("lastRunId"),
                "variant": dict(variant),
            }

            normalized_record = _validate_variant_record(record)
...
async def load_bikedekho_scooter_trim_specs_features_variants(
    *,
    selected_brand: str | None = None,
    selected_model: str | None = None,
    selected_model_id: int | None = None,
    ...
    async for variant_record in iter_bikedekho_scooter_trim_specs_features_variants(
    ...
    if not variants:
        raise LookupError(
            "No BikeDekho scooter variants matched the provided "
            "trim specs/features filters."
        )

    return variants


def build_bikedekho_scooter_trim_specs_features_job(
    *,
    run_id: str,
    ...
    job_id = f"scooter-variant:{variant_id}"
    ...
    return ScraperJob.create(
        ...
        metadata={
            ...
            "sourceScooterDocumentId": (
                normalized_variant_record.get("scooterDocumentId")
            ),
            "sourceScooterRunId": (normalized_variant_record.get("sourceScooterRunId")),
...
def build_bikedekho_scooter_trim_specs_features_jobs(
    *,
    run_id: str,
    ...
    for variant_record in variant_records:
        job = build_bikedekho_scooter_trim_specs_features_job(
            run_id=run_id,

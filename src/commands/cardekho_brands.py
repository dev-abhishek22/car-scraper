...
from src.external.executors.cardekho.brands import (
    CarDekhoBrandsExecutor,
)
...
async def run_cardekho_brands() -> dict[str, Any]:
    ...
    try:
        ...
        async with create_cardekho_async_client(
            ...
            executor = CarDekhoBrandsExecutor(
                client=client,
            )

            brands = await executor.execute()

            upsert_result = await cardekho_brand_repository.bulk_upsert(
                brands,
                run_id=run_id,
            )
        ...
        logger_service.info(
            (
                "CarDekho brands scraping completed: "
                f"run_id={run_id}, "
        ...
        try:
            ...
            await scraper_run_repository.mark_failed(
                ...
                error=error,
                stop_reason=("CarDekho brands scraping failed"),
